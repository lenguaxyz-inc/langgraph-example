...
book_hotel_safe_tools = [tools.search_hotels]
book_hotel_sensitive_tools = [tools.book_hotel, tools.update_hotel, tools.cancel_hotel]
...
book_car_rental_safe_tools = [tools.search_car_rentals]
...
book_excursion_safe_tools = [tools.search_trip_recommendations]
book_excursion_sensitive_tools = [tools.book_excursion, tools.update_excursion, tools.cancel_excursion]
